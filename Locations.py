...
frickbears3_locations = {
    ...
    "Salvage Animdude": LocData(19875036, "Backdoor"),
    "Salvage Chipper": LocData(19875037, "Backdoor"),
    ...
    "Purchase AP Item #12": LocData(19875053, "Salvage2"),
    "Purchase AP Item #13": LocData(19875054, "Salvage2"),
    "Purchase AP Item #14": LocData(19875055, "Salvage2"),
    "Purchase AP Item #15": LocData(19875056, "Salvage2"),
    "Purchase AP Item #16": LocData(19875057, "Salvage2"),
    "Purchase AP Item #17": LocData(19875058, "Salvage2"),
    "Purchase AP Item #18": LocData(19875059, "Salvage2"),
    "Purchase AP Item #19": LocData(19875060, "Salvage2"),
    "Purchase AP Item #20": LocData(19875061, "Salvage2"),
    "Purchase AP Item #21": LocData(19875062, "Salvage2"),
    "Purchase AP Item #22": LocData(19875063, "Salvage3"),
    "Purchase AP Item #23": LocData(19875064, "Salvage3"),
    "Purchase AP Item #24": LocData(19875065, "Salvage3"),
    "Purchase AP Item #25": LocData(19875066, "Salvage3"),
    "Purchase AP Item #26": LocData(19875067, "Salvage3"),
    "Purchase AP Item #27": LocData(19875068, "Salvage3"),
    "Purchase AP Item #28": LocData(19875069, "Salvage3"),
    "Purchase AP Item #29": LocData(19875070, "Salvage3"),
    "Purchase AP Item #30": LocData(19875071, "Salvage3"),
    "Purchase AP Item #31": LocData(19875072, "Salvage3"),
    "Purchase AP Item #32": LocData(19875073, "Salvage4"),
    "Purchase AP Item #33": LocData(19875074, "Salvage4"),
    "Purchase AP Item #34": LocData(19875075, "Salvage4"),
    "Purchase AP Item #35": LocData(19875076, "Salvage4"),
    "Purchase AP Item #36": LocData(19875077, "Salvage4"),
    "Purchase AP Item #37": LocData(19875078, "Salvage4"),
    "Purchase AP Item #38": LocData(19875079, "Salvage4"),
    "Purchase AP Item #39": LocData(19875080, "Salvage4"),
    "Purchase AP Item #40": LocData(19875081, "Salvage4"),
    "Purchase AP Item #41": LocData(19875082, "Salvage4"),
